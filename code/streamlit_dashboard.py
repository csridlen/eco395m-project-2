...
inputs = [neighborhood_group, minimum_nights, number_of_reviews, calculated_host_listings_count, availability_365, number_of_reviews_ltm, room_type, neighborhood]

X = pd.DataFrame(inputs, columns = ['neighborhood_group', 'minimum_nights','number_of_reviews', 'calculated_host_listings_count', 'availability_365', 'number_of_reviews_ltm', 'room_type', 'neighborhood' ])
